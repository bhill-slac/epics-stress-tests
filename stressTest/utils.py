"""
Script for small utility functions used in epics-stress-tests
"""
############
# Standard #
############
...
def absolute_submodule_path(submodule, cur_dir=inspect.stack()[0][1]):
    """
    Returns the absolute path of the `epics-stress-tests`
...
DIR_MODULE = Path(absolute_submodule_path("epics-stress-tests/"))
